...
output_html = "bus_stops_toggle_map.html"
...
for route_index, route in enumerate(routes_data["routes"], start=1):
    ...
    fg = folium.FeatureGroup(name=f"Route {route_index}", show=True)

    # Add stops to this route's group
